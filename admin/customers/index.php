        ...
        <main class="flex-1">
            <div class="px-4 sm:px-6 lg:px-8 py-8">
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <h1 class="text-2xl font-semibold text-white">Customers</h1>
                    <a href="../../admin/customers/create.php" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg">
                            ...
                            <tbody class="bg-gray-800 divide-y divide-gray-700">
                                <?php foreach ($customers as $customer): ?>
                                    <tr class="hover:bg-gray-900">
                                        <td class="px-6 py-4">
                                            <a href="../../admin/customers/detail.php?id=<?= $customer['id'] ?>" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                                                <?= htmlspecialchars($customer['name']) ?>
                                            </a>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"><?= htmlspecialchars($customer['email']) ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"><?= htmlspecialchars($customer['phone']) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>

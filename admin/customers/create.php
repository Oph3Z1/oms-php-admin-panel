            ...
            <div class="px-4 sm:px-6 lg:px-8 py-8">
                <nav class="mb-6 flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-sm">
                        <li><a href="../../admin/customers/index.php" class="text-gray-500 hover:text-gray-300">Customers</a></li>
                        ...
                        <li><span class="text-white font-medium">New customer</span></li>
                    </ol>
                </nav>

                <div class="max-w-2xl mx-auto">
                    <div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
                        <h1 class="text-2xl font-semibold text-white mb-6">New customer</h1>
                        <form method="POST" class="space-y-6">
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-300 mb-1.5">Name</label>
                                <input type="text" name="name" id="name" required class="w-full px-3 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="Anna Andersson">
                            </div>

                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-300 mb-1.5">Email</label>
                                <input type="email" name="email" id="email" required class="w-full px-3 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="anna.andersson@example.com">
                            </div>

                            <div>
                                <label for="phone" class="block text-sm font-medium text-gray-300 mb-1.5">Phone</label>
                                <input type="tel" name="phone" id="phone" required class="w-full px-3 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="+46 70 123 4567">
                            </div>

                            <div class="flex flex-col sm:flex-row gap-3 justify-end pt-6 border-t border-gray-700">
                                <a href="../../admin/customers/index.php" class="px-4 py-2 text-sm font-medium text-gray-300 bg-gray-800 hover:bg-gray-900 border border-gray-600 rounded-lg text-center">Cancel</a>

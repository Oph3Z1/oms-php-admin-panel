        ...
        <main class="flex-1">
            <div class="px-4 sm:px-6 lg:px-8 py-8">
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <a href="../../admin/orders/create.php" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg">
                ...
                <div class="mb-4">
                    <p class="text-sm text-gray-400" data-showing-text>Showing 1–10 of <?= getOrdersCount($conn) ?></p>
                </div>
                ...
                <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-700">
                            ...
                            <tbody class="bg-gray-800 divide-y divide-gray-700" data-table-body>
                                <?php foreach ($orders as $order): ?>
                                    <tr class="hover:bg-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400"><?= $order["order_date"] ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div class="bg-gray-800 px-6 py-4 border-t border-gray-700">
                        <nav class="relative z-0 inline-flex rounded-lg shadow-sm -space-x-px" aria-label="Pagination" data-pagination-container></nav>
                    </div>
                </div>
            </div>
        </main>
